...
std::unique_ptr<Command> CommandFactory::createCommand(const std::string& commandType, std::vector<User>& players, std::queue<Card>& deck, int playerIndex) {
...
std::unique_ptr<Command> CommandFactory::createCommand(const std::string& commandType, std::vector<User>& players, std::priority_queue<UserScoreInfo>& rankQueue) {
